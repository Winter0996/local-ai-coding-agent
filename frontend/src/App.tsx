    ...
    <section className="panel">
      <div className="panel-header">
        <div>
          ...
          <p>
            {workspace ? (
              <>Grounded in {workspace.name}</>
            ) : (
              "Open a repository to ground answers in your code"
            )}
          </p>
        </div>
        <div className="panel-header-actions">{model && <span className="model-badge">{model}</span>}</div>
      </div>
        ...
        {!isAuthenticated && !isLoading && (
          <section className="hero">
            ...
            <p className="subtitle">
              A local-first engineering assistant powered by Ollama. No paid
              AI APIs. No API keys. No credit card.
            </p>
          </section>
        )}
